							...
							<div class="thumbnail">
								<div class="caption">
									<h5 align="right" style="margin-right:10px">
										<a href="newTax.php"><? echo lang('ADD_TAX');?></a>
									</h5>
								</div>
								<div class="widget-content">
									<div id="topHeaderDiv">
										...
										<div id="centerHeader">
											<table style="margin:5px 0 0 0">
												<tr>
													<td width="60px" align="center"><b><?echo lang('SRNO');?></b></td>
													<td width="240px" align="center"><b><?echo lang('TAX');?></b></td>
													<td width="145px" align="center"><b><?echo lang('TAX_V');?></b></td>
									...
									<ul class="thumbnails">
										<li class="span5" style="width:98%">
											<div id="taxReslt"><img src="images/loader.gif" style="margin:40px 0 0 200px;" alt=""/></div> 
										</li>
									</ul>
								</div>
