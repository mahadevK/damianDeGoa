							...
							<div class="thumbnail">
								<div class="caption">
									<h5 align="right" style="margin-right:10px">
										<a href="newUser.php"><? echo lang('ADD_USERS');?></a>
									</h5>
								</div>
								<div class="widget-content" style="padding:2% 0 0 2%">
									<div id="topHeaderDiv">
										...
										<div id="centerHeader2">
											<table style="margin:.8% 0 0 0;width:100%">
												<tr>
													<td width="20%" align="center"><b><?echo lang('USERS_NAME');?></b></td>
													<td width="20%" align="center"><b><?echo lang('USERS_ROLE');?></b></td>
													<td width="20%" align="center"><b><?echo lang('USERS_OUTLET');?></b></td>
									...
									<ul class="thumbnails">
										<li class="span5" style="width:98%">
											<div id="usersResult"><img src="images/loader.gif" style="margin:40px 0 0 495px;" alt=""/></div> 
										</li>
									</ul>
								</div>
