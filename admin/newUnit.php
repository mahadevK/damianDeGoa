							...
							<div class="thumbnail">
								<div class="caption">
									<h5 align="right" style="margin-right:10px">
										<a href="Units.php"><? echo lang('VEW_UNITS');?></a>
									</h5>
								</div>
								<div class="widget-content">
									<table width="600px" align="center">
										...
										<tr>
											<td width="600px">
												<?echo lang('UNIT');?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp; 
												<input type="text" name="units" id="units" style="width:450px">
											</td>
										</tr>
										<tr height="10px;"></tr>
										<tr>
											<td width="600px">
												<?echo lang('UNITS_FOR');?> &nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp; 
												<select id="unitFor" name="unitFor" style="width:460px">
													<option value="">Select</option>
													<option value="1">Diamension (width*height)</option>
										...
										<tr>
											<td align="center">
												<input type="submit" name="submit" id="submit" value="Submit" onclick="return valUnits()">&nbsp;&nbsp;&nbsp; 
												<input name="Cancel" type="button" id="Cancel" value="Cancel" onclick="window.location.href='Units.php';" />
