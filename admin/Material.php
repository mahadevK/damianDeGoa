							...
							<div class="thumbnail">
								<div class="caption">
									<h5 align="right" style="margin-right:10px">
										<a href="newMatrial.php"><? echo lang('ADD_MATRL');?></a>
									</h5>
								</div>
								<div class="widget-content">
									<div id="topHeaderDiv">
										...
										<div id="centerHeader">
											<table style="margin:5px 0 0 0">
												<tr>
													<td width="430px" align="center"><b><?echo lang('MATERIAL');?></b></td>
									...
									<ul class="thumbnails">
										<li class="span5" style="width:98%">
											<div id="matrlReslt"><img src="img/loader.gif" style="margin:40px 0 0 200px;" alt=""/></div> 
										</li>
									</ul>
								</div>
