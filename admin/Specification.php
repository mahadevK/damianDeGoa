							...
							<div class="thumbnail">
								<div class="caption">
									<h5 align="right" style="margin-right:10px">
										<a href="newSpecificatn.php"><? echo lang('ADD_PROD_SPEC');?></a>
									</h5>
								</div>
								<div class="widget-content">
									<div id="topHeaderDiv">
										...
										<div id="centerHeader2">
											<table style="margin:.8% 0 0 0;width:100%">
												<tr>
													<td width="40%" align="center"><b><?echo lang('PROD_NME');?></b></td>
													<td width="15%" align="center"><b><?echo lang('PROD_PRCE');?> (Rs.)</b></td>
													<td width="15%" align="center"><b><?echo lang('SIZE');?></b></td>
													<td width="15%" align="center"><b><?echo lang('PROD_STCK');?></b></td>
													<td width="15%" align="center"><b><?echo lang('ACTN');?></b></td>
												</tr>
											</table>
										</div>
									...
									<ul class="thumbnails">
										<li class="span5" style="width:98%">
											<div id="specatnReslt"><img src="images/loader.gif" style="margin:40px 0 0 330px;" alt=""/></div> 
										</li>
									</ul>
								</div>
