		...
		<div class="content">
			<div class="container">
				<div class="page-header">
					<h3><?echo lang('OUTLETS');?></h3>
				</div>
				<div class="row-fluid">
					<ul class="thumbnails">
						<li class="span4" style="width:70%;margin:0 0 0 13%">
							<div class="thumbnail">
								<div class="caption">
									<h5 align="right" style="margin-right:10px">
										<a href="newOutlet.php"><? echo lang('CREATE_OUTLET');?></a>
									</h5>
								</div>
								<div class="widget-content" style="padding:2% 0 0 2%">
										...
										<div id="centerHeader2">
											<table style="margin:5px 0 0 0;width:100%">
												<tr>
													...
													<td width="27%" align="center">City</td>
									...
									<ul class="thumbnails">
										<li class="span5" style="width:98%">
											<div id="outletReslt"><img src="img/loader.gif" style="margin:40px 0 0 200px;" alt=""/></div> 
										</li>
									</ul>
								</div>
