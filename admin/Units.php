							...
							<div class="thumbnail">
								<div class="caption">
									<h5 align="right" style="margin-right:10px">
										<a href="newUnit.php"><? echo lang('ADD_UNITS');?></a>
									</h5>
								</div>
								<div class="widget-content">
									<div id="topHeaderDiv">
										...
										<div id="centerHeader">
											<table style="margin:5px 0 0 0">
												<tr>
													<td width="230px" align="center"><b><?echo lang('UNIT');?></b></td>
													<td width="200px" align="center"><b><?echo lang('UNITS_FOR');?></b></td>
									...
									<ul class="thumbnails">
										<li class="span5" style="width:98%">
											<div id="unitsReslt"><img src="img/loader.gif" style="margin:40px 0 0 200px;" alt=""/></div> 
										</li>
									</ul>
								</div>
