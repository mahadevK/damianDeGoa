								...
								<div class="widget-content">
									<table width="600px" align="center">
										...
										<tr>
											<td width="600px">
												<?echo lang('MATERIAL');?> &nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp; 
												<input type="text" name="material" id="material" style="width:450px">
											</td>
										</tr>
										<tr height="25px;"></tr>
										<tr>
											<td align="center">
												<input type="submit" name="submit" id="submit" value="Submit" onclick="return valMaterial()">&nbsp;&nbsp;&nbsp; 
												<input name="Cancel" type="button" id="Cancel" value="Cancel" onclick="window.location.href='Material.php';" />
