<?php
	if(isset($_POST['printQuotn']) || isset($_POST['printQuotn_x']))
	{
		...
		$mpdf->WriteHTML('<td style="width:30%">');
		$mpdf->WriteHTML('<table><tr><td>');
		$mpdf->WriteHTML('<b>Quotation No</b> '.$QatnNo);
		$mpdf->WriteHTML('</td></tr>');
		$mpdf->WriteHTML('<tr><td>');
		...
		$mpdf->WriteHTML('<table style="width:750px;border:1px solid #000">');
		$mpdf->WriteHTML('<tr><td style="width:350px;border-bottom:1px solid #000;border-right:1px solid #000;text-align:center">');
		$mpdf->WriteHTML('DESCRIPTION');
		$mpdf->WriteHTML('</td>');
		$mpdf->WriteHTML('<td style="width:75px;border-bottom:1px solid #000;border-right:1px solid #000;text-align:center">');
		$mpdf->WriteHTML('QTY');
		$mpdf->WriteHTML('</td>');
		$mpdf->WriteHTML('<td style="width:75px;border-bottom:1px solid #000;border-right:1px solid #000;text-align:center">');
		$mpdf->WriteHTML('UNIT');
		$mpdf->WriteHTML('</td>');
		$mpdf->WriteHTML('<td style="width:100px;border-bottom:1px solid #000;border-right:1px solid #000;text-align:center">');
		$mpdf->WriteHTML('RATE');
		$mpdf->WriteHTML('</td>');
		$mpdf->WriteHTML('<td style="width:150px;border-bottom:1px solid #000;text-align:center">');
		...
		for($i=0;$i<$counter;$i++)
		{
			...
			$mpdf->WriteHTML('<tr><td style="width:350px;text-align:left">');
			$mpdf->WriteHTML($quotnTxt);
			$mpdf->WriteHTML('</td>');
			$mpdf->WriteHTML('<td style="width:75px;border-left:1px solid #000;text-align:center">');
			$mpdf->WriteHTML($quotnQty);
			$mpdf->WriteHTML('</td>');
			$mpdf->WriteHTML('<td style="width:75px;border-left:1px solid #000;text-align:center">');
			$mpdf->WriteHTML($quotnUnit);
			$mpdf->WriteHTML('</td>');
			$mpdf->WriteHTML('<td style="width:100px;border-left:1px solid #000;text-align:center">');
			$mpdf->WriteHTML($quotnRate);
			$mpdf->WriteHTML('</td>');
			$mpdf->WriteHTML('<td style="width:150px;border-left:1px solid #000;text-align:right">');
		...
		$mpdf->WriteHTML('<table style="width:750px;border-left:1px solid #000;">');
		$mpdf->WriteHTML('<tr><td style="width:350px;">');
		$mpdf->WriteHTML('<table style="width:325px;margin:0 0 0 25px;font-size:12px">');
		...
		$mpdf->WriteHTML('<td style="width:400px;">');
		$mpdf->WriteHTML('<table style="width:400px;border:1px solid #000;">');
		$mpdf->WriteHTML('<tr><td style="width:250px;border-right:1px solid #000;border-bottom:1px solid #000">Total</td>');
		$mpdf->WriteHTML('<td style="width:150px;border-bottom:1px solid #000;text-align:right">');
		$mpdf->WriteHTML($totalAmount);
		$mpdf->WriteHTML('</td></tr>');
		$mpdf->WriteHTML('<tr><td style="width:250px;border-right:1px solid #000;border-bottom:1px solid #000">Excise</td>');
		$mpdf->WriteHTML('<td style="width:150px;border-bottom:1px solid #000;text-align:right">');
		...
		$mpdf->WriteHTML('</td></tr>');
		$mpdf->WriteHTML('<tr><td style="width:250px;border-right:1px solid #000">S.T</td>');
		$mpdf->WriteHTML('<td style="width:150px;text-align:right">');
		...
		$mpdf->WriteHTML('<table style="width:750px;border-left:1px solid #000;border-right:1px solid #000">');
		$mpdf->WriteHTML('<tr><td style="width:350px;text-align:right;border-right:1px solid #000">G. TOTAL  </td>');
		$mpdf->WriteHTML('<td style="width:400px;">');
		$mpdf->WriteHTML('<table style="width:400px;">');
		$mpdf->WriteHTML('<tr><td style="width:250px;border-right:1px solid #000;" colspan="3"></td>');
		...
		$mpdf->WriteHTML('<table style="width:750px;border:1px solid #000;">');
		$mpdf->WriteHTML('<tr>');
		$mpdf->WriteHTML('<td style="width:350px;font-size:12px">');
		$mpdf->WriteHTML('<table style="width:325px;margin:0 0 0 25px;font-size:14px">');
		...
		$mpdf->WriteHTML('</table></td>');
		$mpdf->WriteHTML('<td style="width:400px;border-left:1px solid #000;">');
		$mpdf->WriteHTML('<table style="width:390px;text-align:right">');
